...
const JoinWorkshop = () => {
  return (
    <div className='pt-20 w-screen bg-dark_blue_image py-10 px-4 flex flex-col justify-center items-center gap-5'>
      ...
      Unlock the Power of{" "}
        <span style={{ color: "#E69B2F" }}>High-Quality Leads</span> to
         Stock Market  <span style={{ color: "#E69B2F" }}>Success</span>
      </p>
    </div>
  )
}
